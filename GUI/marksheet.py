...
def display():
	...
	if e4.get() == "A":
		...
		tk.Label(master, text ="90").grid(row=3, column=4)
		tot += 90
	...
	if e4.get() == "C":
		tk.Label(master, text ="70").grid(row=3, column=4)
		tot += 70
		
	# 7*number of subject credits
	# give total credits for grade D
	if e4.get() == "D":
		tk.Label(master, text ="50").grid(row=3, column=4)
		tot += 50
	...
	if e5.get() == "A":
		tk.Label(master, text ="90").grid(row=4, column=4)
		tot += 90
	if e5.get() == "B":
		tk.Label(master, text ="80").grid(row=4, column=4)
		tot += 80
	if e5.get() == "C":
		tk.Label(master, text ="70").grid(row=4, column=4)
		tot += 70
	if e5.get() == "D":
	...
	if e6.get() == "A":
		tk.Label(master, text ="90").grid(row=5, column=4)
		tot += 90
	if e6.get() == "B":
		tk.Label(master, text ="80").grid(row=5, column=4)
		tot += 80
	if e6.get() == "C":
		tk.Label(master, text ="70").grid(row=5, column=4)
		tot += 70
	if e6.get() == "D":
		tk.Label(master, text ="50").grid(row=5, column=4)
		tot += 50
	if e6.get() == "E":
	...
	if e7.get() == "A":
		tk.Label(master, text ="90").grid(row=6, column=4)
		tot += 90
	if e7.get() == "B":
		tk.Label(master, text ="80").grid(row=6, column=4)
		tot += 80
	if e7.get() == "C":
		tk.Label(master, text ="70").grid(row=6, column=4)
		tot += 70
	if e7.get() == "D":
		tk.Label(master, text ="50").grid(row=6, column=4)
		tot += 50
	if e7.get() == "E":
	...
	if e8.get() == "A":
		tk.Label(master, text ="90").grid(row=7, column=4)
		tot += 90
	if e8.get() == "B":
		tk.Label(master, text ="80").grid(row=7, column=4)
		tot += 80
	if e8.get() == "C":
		tk.Label(master, text ="70").grid(row=7, column=4)
		tot += 70
	if e8.get() == "D":
		tk.Label(master, text ="50").grid(row=7, column=4)
		tot += 50
	if e8.get() == "E":
	...
	if e9.get() == "A":
		tk.Label(master, text ="90").grid(row=8, column=4)
		tot += 90
	if e9.get() == "B":
		tk.Label(master, text ="80").grid(row=8, column=4)
		tot += 80
	if e9.get() == "C":
		tk.Label(master, text ="70").grid(row=8, column=4)
		tot += 70
	if e9.get() == "D":
		tk.Label(master, text ="50").grid(row=8, column=4)
		tot += 50
	if e9.get() == "E":
	...
	# to display SGPA
	tk.Label(master, text=str(tot/6)).grid(row=10, column=4)
...
tk.Label(master, text="Myanmar").grid(row=3, column=1)
tk.Label(master, text="English").grid(row=4, column=1)
tk.Label(master, text="Math").grid(row=5, column=1)
tk.Label(master, text="Science").grid(row=6, column=1)
tk.Label(master, text="Computer Science").grid(row=7, column=1)
tk.Label(master, text="History").grid(row=8, column=1)

	
# label for grades
tk.Label(master, text="Grade(A, B, C, D, E, F)").grid(row=2, column=2)
...
tk.Label(master, text="AVG").grid(row=10, column=3)
